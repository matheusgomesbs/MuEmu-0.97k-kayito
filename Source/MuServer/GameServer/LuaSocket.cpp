...
#ifndef OLD_LUA
void CSocket::SetGlobalFunctions(sol::state& lua)
{
	lua.set_function(("CreatePacket"), &CreatePacket);

	lua.set_function(("SetDwordPacket"), &SetDwordPacket);

	lua.set_function(("GetDwordPacket"), &GetDwordPacket);

	lua.set_function(("SetWordPacket"), &SetWordPacket);

	lua.set_function(("GetWordPacket"), &GetWordPacket);

	lua.set_function(("SetBytePacket"), &SetBytePacket);

	lua.set_function(("GetBytePacket"), &GetBytePacket);

	lua.set_function(("SetCharPacket"), &SetCharPacket);

	lua.set_function(("SetCharPacketLength"), &SetCharPacketLength);

	lua.set_function(("GetCharPacket"), &GetCharPacket);

	lua.set_function(("GetCharPacketLength"), &GetCharPacketLength);

	lua.set_function(("SendPacket"), &SendPacket);

	lua.set_function(("ClearPacket"), &ClearPacket);
}
#else
