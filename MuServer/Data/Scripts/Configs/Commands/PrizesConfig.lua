...
PRIZES_COMMANDS = {
{Command = '/addevento', TableE = 'Character', ColumnE = 'EventPoints', WhereE = 'Name', TableA = 'CashShopData', ColumnA = 'WCoinP', WhereA = 'AccountID', Name = 'Parabéns você foi premiado', Players = 1, Points_1 = 5, Amounts_1 = 5, Points_2 = 0, Amounts_2 = 0, Points_3 = 0, Amounts_3 = 0},
